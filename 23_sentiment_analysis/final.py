...
event_dates_data = pd.read_csv('/Users/algo trading 2025/batch 31/17_sentiment/apple_events_new.csv')
...
stock_prices_data = pd.read_csv('/Users/algo trading 2025/batch 31/17_sentiment/AAPL_history.csv', index_col=0)
...
daily_sentiment_scores = pd.read_csv('/Users/algo trading 2025/batch 31/17_sentiment/daily_sentiment_scores_2016_jan_2023_sep.csv', index_col=0)
...
daily_sentiment_scores['rolling_20_mean'] = daily_sentiment_scores.sentiment_score.rolling(20).mean()
print(daily_sentiment_scores)
...
print(stock_prices_data)
stock_prices_data.to_csv('sample1.csv')
